...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link href="${rootURL}resources/css/bootstrap-min.css" rel="stylesheet" />
        ...
        top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
                ...
                top: 0px; left: 0px; width: 100%; height: 100%;">
                    ...
                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px; height: 500px; overflow: hidden;">
                        <div>
                            <img u="image" src2="${rootURL}resources/images/red.jpg" />
                        </div>
                        <div>
                            <img u="image" src2="${rootURL}resources/images/purple.jpg" />
                        </div>
                        <div>
                            <img u="image" src2="${rootURL}resources/images/blue.jpg" />
                        </div>
                    </div>
