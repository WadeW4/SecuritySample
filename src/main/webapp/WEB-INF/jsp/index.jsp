...
<div class="container">
	...
	<div id="slider1_container" style="display: none; position: relative; margin: 0 auto; width: 980px;
		...
		<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1140px; height: 442px;
            overflow: hidden;">
			<div>
				<img u="image" src2="${rootURL}resources/images/carousel/01.jpg" />
			</div>
			<div>
				<img u="image" src2="${rootURL}resources/images/carousel/02.jpg" />
			</div>
			<div>
				<img u="image" src2="${rootURL}resources/images/carousel/03.jpg" />
			</div>
			<div>
				<img u="image" src2="${rootURL}resources/images/carousel/04.jpg" />
			</div>
		</div>
		...
		<style>
            ...
            */
			.jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
				background: url(${rootURL}resources/images/carousel/b05.png) no-repeat;
				overflow: hidden;
				cursor: pointer;
			}
		...
		<style>
            ...
            */
			.jssora11l, .jssora11r, .jssora11ldn, .jssora11rdn {
				...
				cursor: pointer;
				display: block;
				background: url(${rootURL}resources/images/carousel/a11.png) no-repeat;
				overflow: hidden;
			}
...
<script type="text/javascript"           src="${rootURL}resources/js/ie10-viewport-bug-workaround.js"></script>
